...
const HomeWelcomeSec = () => {
  return (
    <div className="h-screen w-full">
      <div className="relative h-[303.552px] w-[458.30400000000003px] sm:h-[40%] sm:w-full left-1/2 -translate-x-1/2">
        <Image
        className=""
        ...
        />
        <div className="tint w-full h-full bg-[#721800] opacity-30 absolute top-0 z-10"></div>
